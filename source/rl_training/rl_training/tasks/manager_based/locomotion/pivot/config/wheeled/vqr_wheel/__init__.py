...
#Register cho task pivot
gym.register(
    id="Pivot-VQR-Wheel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": f"{__name__}.pivot_env_cfg:VQRWheelPivotEnvCfg",
            "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:VQRWheelPivotPPORunnerCfg"},
)
gym.register(
    id="Pivot-VQR-Wheel-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pivot_env_cfg:VQRWheelPivotEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:VQRWheelPivotPPORunnerCfg",
    },
)