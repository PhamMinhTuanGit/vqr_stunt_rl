...
@configclass
class VQRWheelRoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 20000
    save_interval = 500
    experiment_name = "vqr_wheel_rough"
...
@configclass
class VQRWheelIMURoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 20000
    save_interval = 500
    experiment_name = "vqr_wheel_imu_rough"
    empirical_normalization = False
    clip_actions = 100
    policy = RslRlPpoActorCriticCfg(
        init_noise_std=1.0,
...
@configclass
class VQRWheelFlatPPORunnerCfg(VQRWheelRoughPPORunnerCfg):
