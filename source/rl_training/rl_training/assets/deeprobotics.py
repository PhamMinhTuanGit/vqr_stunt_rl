...
VQRWHEEL_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/VQRWheel/VQRWheel_usd/VQRWheel.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    actuators={
        "joint": DelayedPDActuatorCfg(
            ...
            effort_limit={".*_HipX_joint": 60.0, ".*_HipY_joint": 60.0, ".*_Knee_joint": 60.0},
            velocity_limit={".*_HipX_joint": 14.66, ".*_HipY_joint": 14.66, ".*_Knee_joint": 14.66},
            stiffness=80.0,
            damping={".*_HipX_joint": 1.524, ".*_HipY_joint": 1.431, ".*_Knee_joint": 0.859},
            friction=0.0,
            armature=0.0,
            min_delay=2,
            max_delay=8,
...
VQR_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/VQR/VQR_usd/VQR.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    actuators={
        "joint": DelayedPDActuatorCfg(
            joint_names_expr=[".*_HipX_joint", ".*_HipY_joint", ".*_Knee_joint"],
            effort_limit={".*_HipX_joint": 16.0, ".*_HipY_joint": 16.0, ".*_Knee_joint": 16.0},
            velocity_limit={".*_HipX_joint": 14.66, ".*_HipY_joint": 14.66, ".*_Knee_joint": 14.66},
            stiffness=80.0,
            damping=2.0,
            friction=0.0,
            armature={".*_HipX_joint": 0.010, ".*_HipY_joint": 0.010, ".*_Knee_joint": 0.025},
            min_delay=0,
            max_delay=1,
        ),
    },
